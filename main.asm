...
; generated by prog8.codegen.cpu6502.ProgramAndVarsGen on 2023-12-05T12:16:29
...
p8_fmalloc_root	.proc
	...
	; source: src\fmalloc.p8:7   fmalloc_root {
	; source: src\fmalloc.p8:8   
	; source: src\fmalloc.p8:9   
	; source: src\fmalloc.p8:10   
	; source: src\fmalloc.p8:11   const ubyte SIZEOF_FMALLOC      = $0c;
	; source: src\fmalloc.p8:13   const ubyte FMALLOC_available   = $00; ubyte[3]

p8_available_get	.proc
; statements
	; source: src\fmalloc.p8:14   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_result	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:17   const ubyte FMALLOC_freemem     = $06; uword

p8_available_set	.proc
; statements
	; source: src\fmalloc.p8:18   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:25   sub available_get(uword ptr, uword result) {

p8_assigned_set	.proc
; statements
	; source: src\fmalloc.p8:26   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:29   }

p8_freemem_get	.proc
; statements
	; source: src\fmalloc.p8:30   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_result	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:33   sub available_set(uword ptr, uword value) {

p8_freemem_set	.proc
; statements
	; source: src\fmalloc.p8:34   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:37   }

p8_freemem_set_wi	.proc
; statements
	; source: src\fmalloc.p8:38   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:41   sub assigned_get(uword ptr, uword result) {

p8_totalmem_get	.proc
; statements
	; source: src\fmalloc.p8:42   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_result	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:45   }

p8_totalmem_set	.proc
; statements
	; source: src\fmalloc.p8:46   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:49   sub assigned_set(uword ptr, uword value) {

p8_totalmem_set_wi	.proc
; statements
	; source: src\fmalloc.p8:50   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:53   }

p8_totalnodes_get	.proc
; statements
	; source: src\fmalloc.p8:54   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_result	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:57   sub freemem_get(uword ptr, uword result) {

p8_totalnodes_set	.proc
; statements
	; source: src\fmalloc.p8:58   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:61   }

p8_totalnodes_set_wi	.proc
; statements
	; source: src\fmalloc.p8:62   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_fmalloc_item	.proc
	; source: src\fmalloc.p8:67   struct.set_w(ptr, FMALLOC_freemem, value);
	...
	; source: src\fmalloc.p8:68   
	; source: src\fmalloc.p8:69   }
	; source: src\fmalloc.p8:70   
	; source: src\fmalloc.p8:71   
	; source: src\fmalloc.p8:73   sub freemem_set_wi(uword ptr, uword value) {

p8_next_get	.proc
; statements
	; source: src\fmalloc.p8:74   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_result	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:77   }

p8_next_set	.proc
; statements
	; source: src\fmalloc.p8:78   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:81   sub totalmem_get(uword ptr, uword result) {

p8_prev_get	.proc
; statements
	; source: src\fmalloc.p8:82   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_result	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:85   }

p8_prev_set	.proc
; statements
	; source: src\fmalloc.p8:86   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_value	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:89   sub totalmem_set(uword ptr, uword value) {

p8_size_get	.proc
; statements
	; source: src\fmalloc.p8:90   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_result	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:93   }

p8_size_set	.proc
; statements
	; source: src\fmalloc.p8:94   
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
; ---- block: 'p8_fmalloc' ----
p8_fmalloc	.proc
	; source: src\fmalloc.p8:102   


	; source: src\fmalloc.p8:105   sub totalnodes_get(uword ptr, uword result) {
...
; statements
	...
	; source: src\fmalloc.p8:107   struct.get_w(ptr, FMALLOC_totalnodes, result);
	lda  p8_pm
	ldy  p8_pm+1
...
p8_pm	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:114   

p8_addblock	.proc
; statements
	; source: src\fmalloc.p8:117   }
	; source: src\fmalloc.p8:121   sub totalnodes_set_wi(uword ptr, uword value) {
	; source: src\fmalloc.p8:126   
	; source: src\fmalloc.p8:135   const ubyte SIZEOF_FMALLOC_ITEM = $08;
	; source: src\fmalloc.p8:117   }
	lda  p8_size
	ldy  p8_size+1
	sta  p8_usableSize
...
+
	...
	; source: src\fmalloc.p8:123   struct.set_wi(ptr, FMALLOC_totalnodes, value);
	lda  p8_freemem
	clc
	adc  p8_usableSize
	sta  p8_freemem
	...
	; source: src\fmalloc.p8:137   const ubyte FMALLOC_ITEM_prev   = $00; ubyte[3]
	inc  p8_totalnodes
	bne  +
	inc  p8_totalnodes+1
+
...
p8_usableSize	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:144   

p8_malloc	.proc
; statements
	; source: src\fmalloc.p8:205   ;const ubyte FMALLOC_ITEM_next   = $03; ubyte[3]
	; source: src\fmalloc.p8:187   fstruct.set_w(ptr, FMALLOC_ITEM_size, value);
	; source: src\fmalloc.p8:185   sub size_set(ubyte[3] ptr, uword value) {
	; source: src\fmalloc.p8:180   
	; source: src\fmalloc.p8:145   sub next_get(ubyte[3] ptr, uword result) {
	; source: src\fmalloc.p8:146   
	; source: src\fmalloc.p8:147   fstruct.get(ptr, FMALLOC_ITEM_next, fptr.SIZEOF_FPTR, result);
...
+
	...
	sta  p8_size
	sty  p8_size+1
	; source: src\fmalloc.p8:153   sub next_set(ubyte[3] ptr, uword value) {
	sec
	sbc  #8
	sta  p8_size
	bcs  +
...
prog8_label_asm_5_if_end
	; source: src\fmalloc.p8:171   fstruct.set(ptr, FMALLOC_ITEM_prev, fptr.SIZEOF_FPTR, value);
	lda  p8_pm
	ldy  p8_pm+1
	...
	jsr  p8_fmalloc.p8_insert_item
	; source: src\fmalloc.p8:177   sub size_get(ubyte[3] ptr, uword result) {
	ldy  p8_current_size+1
	lda  p8_current_size
	cmp  p8_size
	bne  +
...
+
	...
	jsr  p8_fmalloc_item.p8_next_set
	; source: src\fmalloc.p8:193   sub size_set_wi(ubyte[3] ptr, uword value) {
	lda  p8_size
	ldy  p8_size+1
	sta  p8_current_size
	sty  p8_current_size+1
	; source: src\fmalloc.p8:194   
	lda  #<p8_current+0
	ldy  #>p8_current+0
	sta  p8_fmalloc_item.p8_size_set.p8_ptr
	sty  p8_fmalloc_item.p8_size_set.p8_ptr+1
...
prog8_label_asm_6_if_end
	; source: src\fmalloc.p8:215   fmalloc_root.freemem_set_wi(pm, 0);
	lda  p8_pm
	ldy  p8_pm+1
	sta  p8_fmalloc_root.p8_freemem_get.p8_ptr
	sty  p8_fmalloc_root.p8_freemem_get.p8_ptr+1
	...
	sta  p8_freemem+1
	; source: src\fmalloc.p8:217   fmalloc_root.totalmem_set_wi(pm, 0);
	lda  p8_pm
	ldy  p8_pm+1
	sta  p8_fmalloc_root.p8_freemem_set.p8_ptr
	sty  p8_fmalloc_root.p8_freemem_set.p8_ptr+1
...
p8_totalnodes	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:227   sub addblock(uword pm, ubyte[fptr.SIZEOF_FPTR] ptr, uword size) {

p8_free	.proc
; statements
	; source: src\fmalloc.p8:233   uword usableSize = size - fmalloc_item.SIZEOF_FMALLOC_ITEM;
	; source: src\fmalloc.p8:234   
	; source: src\fmalloc.p8:242   
	; source: src\fmalloc.p8:243   fmalloc_root.freemem_get(pm, &freemem);
	; source: src\fmalloc.p8:230   
	lda  #<p8_ptr+0
	ldy  #>p8_ptr+0
	sta  p8_fptr.p8_compare.p8_ptr1
	sty  p8_fptr.p8_compare.p8_ptr1+1
...
+
	; source: src\fmalloc.p8:235   fmalloc_item.size_set(ptr, &usableSize)
	ldy  #0
	lda  p8_ptr
	sta  P8ZP_SCRATCH_W1
	lda  p8_ptr+1
	...
	lda  p8_temp_result
	sta  p8_node+1
	; source: src\fmalloc.p8:237   
	lda  p8_temp_result+1
	sta  p8_node+2
	; source: src\fmalloc.p8:240   
	ldy  p8_pm+1
	lda  p8_pm
	clc
	adc  #<3
	...
	jsr  p8_fmalloc_root.p8_freemem_get
	; source: src\fmalloc.p8:245   freemem = freemem + usableSize;
	lda  #<p8_node+0
	ldy  #>p8_node+0
	sta  p8_fmalloc_item.p8_size_get.p8_ptr
	sty  p8_fmalloc_item.p8_size_get.p8_ptr+1
	...
	adc  p8_node_size+1
	sta  p8_freemem+1
	; source: src\fmalloc.p8:247   fmalloc_root.freemem_set(pm, &freemem);
	lda  p8_pm
	ldy  p8_pm+1
	sta  p8_fmalloc_root.p8_freemem_set.p8_ptr
	sty  p8_fmalloc_root.p8_freemem_set.p8_ptr+1
	...
	jsr  p8_fmalloc.p8_insert_item
	; source: src\fmalloc.p8:253   fmalloc_root.totalmem_get(pm, &totalmem);
	lda  p8_pm
	ldy  p8_pm+1
...
p8_temp_result	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:256   

p8_merge	.proc
; statements
	; source: src\fmalloc.p8:304   
	; source: src\fmalloc.p8:297   
	; source: src\fmalloc.p8:295   uword temp_result;
	; source: src\fmalloc.p8:293   uword freemem;
	; source: src\fmalloc.p8:257   fmalloc_root.totalmem_set(pm, &totalmem);
	; source: src\fmalloc.p8:258   
	; source: src\fmalloc.p8:259   
	; source: src\fmalloc.p8:260   
	; source: src\fmalloc.p8:261   ; Add it to the available heap
	...
	jsr  p8_fmalloc_item.p8_size_get
	; source: src\fmalloc.p8:267   ; update totalnodes
	lda  p8_node_prev+1
	pha
	lda  p8_node_prev+2
	tay
	...
	lda  p8_node_prev+0
	sta  p8_temp_ptr+0
	; source: src\fmalloc.p8:269   uword totalnodes;
	lda  p8_temp_result
	sta  p8_temp_ptr+1
...
+
	...
	; source: src\fmalloc.p8:273   totalnodes++;
	lda  p8_node_prev+0
	ldy  p8_node
	sty  P8ZP_SCRATCH_W1
	ldy  p8_node+1
	...
	ldy  #1
	sta  (P8ZP_SCRATCH_W1),y
	; source: src\fmalloc.p8:275   fmalloc_root.totalnodes_set(pm, &totalnodes);
	lda  p8_node_prev+2
	ldy  p8_node
	sty  P8ZP_SCRATCH_W1
	ldy  p8_node+1
	...
	sta  p8_temp_result
	sty  p8_temp_result+1
	; source: src\fmalloc.p8:279   ;dump_fmalloc(pm);
	lda  p8_node_prev+0
	sta  p8_temp_ptr+0
	; source: src\fmalloc.p8:280   
	lda  p8_temp_result
	sta  p8_temp_ptr+1
	; source: src\fmalloc.p8:281   ;walkAvailableChain(pm);
	lda  p8_temp_result+1
	sta  p8_temp_ptr+2
	; source: src\fmalloc.p8:272   
	bra  p8_prog8_label_7_whileloop
p8_prog8_label_8_afterwhile
	; source: src\fmalloc.p8:285   
	lda  p8_node
	ldy  p8_node+1
	sta  p8_fmalloc_item.p8_next_get.p8_ptr
	sty  p8_fmalloc_item.p8_next_get.p8_ptr+1
	...
	jsr  p8_fmalloc_item.p8_size_get
	; source: src\fmalloc.p8:287   sub malloc(uword pm, uword size, ubyte[fptr.SIZEOF_FPTR] result)   {
	ldy  #1
	lda  p8_node
	sta  P8ZP_SCRATCH_W1
	lda  p8_node+1
	...
	lda  (P8ZP_SCRATCH_W1),y
	sta  p8_temp_ptr+0
	; source: src\fmalloc.p8:289   ubyte[fptr.SIZEOF_FPTR] current;
	lda  p8_temp_result
	sta  p8_temp_ptr+1
...
+
	...
	jsr  p8_fmalloc_root.p8_freemem_get
	; source: src\fmalloc.p8:299   ; Round the requested size up to the nearest multiple of 8
	lda  p8_freemem
	clc
	adc  #8
	sta  p8_freemem
...
+
	...
	jsr  p8_fmalloc.p8_remove_item
	; source: src\fmalloc.p8:305   size -= fmalloc_item.SIZEOF_FMALLOC_ITEM
	lda  p8_pm
	ldy  p8_pm+1
	sta  p8_fmalloc_root.p8_totalnodes_get.p8_ptr
	sty  p8_fmalloc_root.p8_totalnodes_get.p8_ptr+1
...
+       dec  p8_totalnodes 
	...
	jsr  p8_fmalloc_root.p8_totalnodes_set
	; source: src\fmalloc.p8:309   ; Find a suitable block
	lda  p8_node_size
	clc
	...
	jsr  p8_fmalloc_item.p8_next_get
	; source: src\fmalloc.p8:313   fmalloc_item.size_get(current, &current_size);
	lda  p8_node
	ldy  p8_node+1
	sta  p8_fmalloc_item.p8_size_get.p8_ptr
	sty  p8_fmalloc_item.p8_size_get.p8_ptr+1
	...
	sta  p8_temp_result
	sty  p8_temp_result+1
	; source: src\fmalloc.p8:315   while (fptr.compare(&current, &fptr.NULL) != fptr.compare_equal) and (current_size < size) {
	ldy  #0
	lda  p8_node
	sta  P8ZP_SCRATCH_W1
	lda  p8_node+1
	...
	lda  p8_temp_result
	sta  p8_temp_ptr+1
	; source: src\fmalloc.p8:317   fmalloc_item.next_get(current, &current);
	lda  p8_temp_result+1
	sta  p8_temp_ptr+2
	; source: src\fmalloc.p8:292   
...
p8_totalnodes	.word  ?
	.send BSS
	.pend
	; source: src\fmalloc.p8:322   

p8_insert_item	.proc
; statements
	; source: src\fmalloc.p8:352   
	; source: src\fmalloc.p8:351   ; If it's not the exact size..
	; source: src\fmalloc.p8:371   fmalloc_item.size_set(newfree, &new_size)
	; source: src\fmalloc.p8:339   ; Remove it from pm->available
	; source: src\fmalloc.p8:323   
	...
	; source: src\fmalloc.p8:327   if fptr.compare(&current, &fptr.NULL) == fptr.compare_equal {
	lda  #<p8_xRoot+0
	ldy  #>p8_xRoot+0
	sta  p8_fptr.p8_compare.p8_ptr1
	sty  p8_fptr.p8_compare.p8_ptr1+1
	...
	lda  (P8ZP_SCRATCH_W1),y
	sta  p8_xRoot+0
	; source: src\fmalloc.p8:329   result[0] = 0;
	ldy  #1
	lda  p8_node
	sta  P8ZP_SCRATCH_W1
	lda  p8_node+1
	...
	lda  (P8ZP_SCRATCH_W1),y
	sta  p8_xRoot+2
	; source: src\fmalloc.p8:331   result[1] = 0;
	lda  p8_node
	ldy  p8_node+1
	...
	jsr  p8_fmalloc_item.p8_next_set
	; source: src\fmalloc.p8:333   result[2] = 0;
	lda  p8_root
	sta  cx16.r0
	lda  p8_root+1
	sta  cx16.r0+1
...
prog8_label_asm_8_if_end
	...
	lda  #<3
	jsr  sys.memcopy
	; source: src\fmalloc.p8:341   remove_item(pm + fmalloc_root.FMALLOC_available, current);
	lda  #<p8_oldroot+0
	ldy  #>p8_oldroot+0
	sta  p8_fmalloc_item.p8_prev_set.p8_ptr
	sty  p8_fmalloc_item.p8_prev_set.p8_ptr+1
	...
	lda  (P8ZP_SCRATCH_W1),y
	sta  p8_xRoot+0
	; source: src\fmalloc.p8:345   ; Add to pm->assigned
	ldy  #1
	lda  p8_node
	sta  P8ZP_SCRATCH_W1
	lda  p8_node+1
...
prog8_label_asm_9_if_else
	...
	lda  #<3
	jsr  sys.memcopy
	; source: src\fmalloc.p8:357   ; Add a free block that's the remainder size
	lda  #<p8_current+0
	ldy  #>p8_current+0
	sta  p8_fmalloc_item.p8_next_get.p8_ptr
	sty  p8_fmalloc_item.p8_next_get.p8_ptr+1
	...
	jsr  p8_fmalloc_item.p8_next_get
	; source: src\fmalloc.p8:359   ubyte[fptr.SIZEOF_FPTR] newfree;
...
+
	...
	lda  #<3
	jsr  sys.memcopy
	; source: src\fmalloc.p8:361   temp_result = mkword (current[2], current[1]) + fmalloc_item.SIZEOF_FMALLOC_ITEM + size;
	lda  #<p8_current+0
	ldy  #>p8_current+0
	sta  p8_fmalloc_item.p8_next_get.p8_ptr
	sty  p8_fmalloc_item.p8_next_get.p8_ptr+1
...
p8_prog8_label_12_afterwhile
	; source: src\fmalloc.p8:365   newfree[1] = lsb(temp_result);
	lda  #<p8_current_next+0
	ldy  #>p8_current_next+0
	sta  p8_fptr.p8_compare.p8_ptr1
	sty  p8_fptr.p8_compare.p8_ptr1+1
	...
	jsr  p8_fmalloc_item.p8_prev_set
	; source: src\fmalloc.p8:367   newfree[2] = msb(temp_result);
	lda  p8_node
	ldy  p8_node+1
	sta  p8_fmalloc_item.p8_next_set.p8_ptr
	sty  p8_fmalloc_item.p8_next_set.p8_ptr+1
...
prog8_label_asm_11_if_else
	...
	jsr  p8_fmalloc_item.p8_next_get
	; source: src\fmalloc.p8:373   ubyte[fptr.SIZEOF_FPTR] current_next;
	lda  #<p8_current+0
	ldy  #>p8_current+0
	sta  p8_fmalloc_item.p8_next_set.p8_ptr
	sty  p8_fmalloc_item.p8_next_set.p8_ptr+1
	...
	jsr  p8_fmalloc_item.p8_prev_set
	; source: src\fmalloc.p8:375   fmalloc_item.next_get(current, &current_next);
	lda  p8_node
	ldy  p8_node+1
	sta  p8_fmalloc_item.p8_next_set.p8_ptr
	sty  p8_fmalloc_item.p8_next_set.p8_ptr+1
...
p8_xRoot	.fill  3
	.send BSS
	.pend
	; source: src\fmalloc.p8:382   

p8_remove_item	.proc
; statements
	; source: src\fmalloc.p8:383   ; Change pm->assigned size
	; source: src\fmalloc.p8:384   
	; source: src\fmalloc.p8:385   current_size = size;
	; source: src\fmalloc.p8:387   fmalloc_item.size_set(current, &current_size);
	lda  p8_node
	ldy  p8_node+1
	sta  p8_fmalloc_item.p8_next_get.p8_ptr
	sty  p8_fmalloc_item.p8_next_get.p8_ptr+1
	...
	; source: src\fmalloc.p8:393   insert_item(pm + fmalloc_root.FMALLOC_available, newfree);
	lda  #<p8_node_prev+0
	ldy  #>p8_node_prev+0
	sta  p8_fmalloc_item.p8_next_set.p8_ptr
	sty  p8_fmalloc_item.p8_next_set.p8_ptr+1
...
prog8_label_asm_14_if_end
	...
	; source: src\fmalloc.p8:401   freemem = freemem - fmalloc_item.SIZEOF_FMALLOC_ITEM;
	lda  #<p8_node_prev+0
	ldy  #>p8_node_prev+0
	sta  p8_fptr.p8_compare.p8_ptr1
	sty  p8_fptr.p8_compare.p8_ptr1+1
...
prog8_label_asm_15_if_end
	...
	jsr  p8_fmalloc_item.p8_next_set
	; source: src\fmalloc.p8:411   fmalloc_root.totalnodes_get(pm, &totalnodes);
	lda  p8_node
	ldy  p8_node+1
	sta  p8_fmalloc_item.p8_prev_set.p8_ptr
	sty  p8_fmalloc_item.p8_prev_set.p8_ptr+1
...
p8_linkedlist_item	.proc
	...
	; source: src\linkedlist.p8:5   
	; source: src\linkedlist.p8:6   
	; source: src\linkedlist.p8:7   linkedlist_item {
	; source: src\linkedlist.p8:8   
	; source: src\linkedlist.p8:10   

p8_next_get	.proc
p8_result 	= 69 	; zp UWORD
p8_ptr 	= 71 	; zp UWORD
; statements
	; source: src\linkedlist.p8:11   const ubyte LINKED_LIST_ITEM_next           = $00; ubyte[fptr.SIZEOF_FPTR]
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
; variables
	...
	.pend
	; source: src\linkedlist.p8:14   

p8_next_set	.proc
p8_value 	= 65 	; zp UWORD
p8_ptr 	= 67 	; zp UWORD
; statements
	; source: src\linkedlist.p8:15   const ubyte LINKED_LIST_ITEM_data           = $06; ubyte[fptr.SIZEOF_FPTR]
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
; variables
	...
	.pend
	; source: src\linkedlist.p8:18   

p8_prev_get	.proc
p8_result 	= 61 	; zp UWORD
p8_ptr 	= 63 	; zp UWORD
; statements
	; source: src\linkedlist.p8:19   sub next_get(ubyte[3] ptr, uword result) {
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
; variables
	...
	.pend
	; source: src\linkedlist.p8:22   

p8_prev_set	.proc
p8_value 	= 57 	; zp UWORD
p8_ptr 	= 59 	; zp UWORD
; statements
	; source: src\linkedlist.p8:23   }
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
; variables
	...
	.pend
	; source: src\linkedlist.p8:26   

p8_data_get	.proc
p8_result 	= 77 	; zp UWORD
p8_ptr 	= 79 	; zp UWORD
; statements
	; source: src\linkedlist.p8:27   sub next_set(ubyte[3] ptr, uword value) {
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
; variables
	...
	.pend
	; source: src\linkedlist.p8:30   

p8_data_set	.proc
p8_value 	= 73 	; zp UWORD
p8_ptr 	= 75 	; zp UWORD
; statements
	; source: src\linkedlist.p8:31   }
	lda  p8_ptr
	sta  cx16.r0
	lda  p8_ptr+1
	sta  cx16.r0+1
...
p8_linkedlist_root	.proc
	; source: src\linkedlist.p8:36   
	p8_LINKED_LIST_ROOT_SIZEOF = 6
	p8_LINKED_LIST_ROOT_head = 0
	p8_LINKED_LIST_ROOT_tail = 3


	; source: src\linkedlist.p8:37   fstruct.get(ptr, LINKED_LIST_ITEM_prev, fptr.SIZEOF_FPTR, result);
	; source: src\linkedlist.p8:38   
	; source: src\linkedlist.p8:39   }
	; source: src\linkedlist.p8:41   
...
; variables
	...
	.pend
	; source: src\linkedlist.p8:45   fstruct.set(ptr, LINKED_LIST_ITEM_prev, fptr.SIZEOF_FPTR, value);
...
; variables
	...
	.pend
	; source: src\linkedlist.p8:53   fstruct.get(ptr, LINKED_LIST_ITEM_data, fptr.SIZEOF_FPTR, result);
...
; ---- block: 'p8_linkedlist' ----
p8_linkedlist	.proc
	; source: src\linkedlist.p8:59   sub data_set(ubyte[3] ptr, uword value) {


	; source: src\linkedlist.p8:61   fstruct.set(ptr, LINKED_LIST_ITEM_data, fptr.SIZEOF_FPTR, value);
...
; statements
	; source: src\linkedlist.p8:74   
	; source: src\linkedlist.p8:75   const ubyte LINKED_LIST_ROOT_head   = $00; ubyte[fptr.SIZEOF_FPTR]
	; source: src\linkedlist.p8:76   
	; source: src\linkedlist.p8:79   
	lda  p8_heap
	ldy  p8_heap+1
	sta  p8_fmalloc.p8_malloc.p8_pm
	sty  p8_fmalloc.p8_malloc.p8_pm+1
	...
	; source: src\linkedlist.p8:89   sub head_set(ubyte[3] ptr, ubyte[3] value) {
	ldy  #>p8_pHead+0
	lda  #<p8_pHead+0
	jsr  p8_fptr.p8_isnull
	cmp  #0
	beq  prog8_label_asm_22_if_else
	; source: src\linkedlist.p8:92   
	lda  p8_root
	ldy  p8_root+1
	sta  p8_linkedlist_root.p8_head_set.p8_ptr
	sty  p8_linkedlist_root.p8_head_set.p8_ptr+1
...
; statements
	...
	ldy  #0
	sta  (p8_result),y
	; source: src\linkedlist.p8:133   sub add_first(uword heap, ubyte[3] root, uword data, ubyte[fptr.SIZEOF_FPTR] result) {
	lda  p8_pTemp+1
	ldy  #1
	sta  (p8_result),y
...
; statements
	...
	; source: src\linkedlist.p8:147   ubyte[fptr.SIZEOF_FPTR] pNew;
	lda  p8_current
	ldy  p8_current+1
	...
	ldy  #0
	sta  (p8_result),y
	; source: src\linkedlist.p8:149   ubyte[fptr.SIZEOF_FPTR] pHead;
	lda  p8_pTemp+1
	ldy  #1
	sta  (p8_result),y
...
; statements
	...
	; source: src\linkedlist.p8:155   ; Create the new object
	lda  p8_current
	ldy  p8_current+1
	...
	ldy  #0
	sta  (p8_result),y
	; source: src\linkedlist.p8:157   fmalloc.malloc(heap, linkedlist_item.LINKED_LIST_ITEM_SIZEOF, pNew);
	lda  p8_pTemp+1
	ldy  #1
	sta  (p8_result),y
...
p8_pTemp	.fill  3
	.send BSS
	.pend
	; source: src\linkedlist.p8:161   ; Set it's data pointer

p8_free	.proc
p8_root 	= 97 	; zp UWORD
p8_heap 	= 99 	; zp UWORD
; statements
	; source: src\linkedlist.p8:168   
	lda  p8_heap
	ldy  p8_heap+1
